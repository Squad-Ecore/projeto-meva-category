...
class CategoryDtoTest {
    ...
    void convertCategory() {
        ...
        assertEquals(category.getId(), categoryRequest.getId());
        assertEquals(category.getDescription(), categoryRequest.getDescription());
    ...
    void testSubCategoryList() {
        ...
        list1.add(new SubCategoryDto(1, "Alimentos", 1));
        list1.add(new SubCategoryDto(2, "Jogos", 1));

        List<SubCategoryDto> list2 = new ArrayList<>();
        list2.add(new SubCategoryDto(3, "Lojas", 1));
        list2.add(new SubCategoryDto(4, "Moveis", 1));
